...
:- include_module tl_runtime.builtin.comparison.
:- import_module tl_runtime.builtin.comparison.

:- include_module tl_runtime.builtin.arithmetic.
:- import_module tl_runtime.builtin.arithmetic.
